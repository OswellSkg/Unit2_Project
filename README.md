...
lower compared to that of the sea surface ground. The low humidity and temperature causes a lot of problems such as skin irritation, throat pain, and eye itchiness. For that reason, Student A from UWC ISAK Japan has requested a way to be updated of local temperature and humidity for low-cost budget. 
